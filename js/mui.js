...
(function($, window, document, name) {
	...
	var OffCanvas = $.Class.extend({
		...
		close: function() {
			...
			if (this.scroller) {
				this.offCanvas && this.offCanvas.offsetHeight;
				this.offCanvas.classList.add(CLASS_TRANSITIONING);
				this.scroller.classList.add(CLASS_TRANSITIONING);
				this.openPercentage(0);
			}
		...
		show: function(direction) {
			...
			if (this.scroller) {
				this.offCanvas && this.offCanvas.offsetHeight;
				this.offCanvas && this.offCanvas.classList.add(CLASS_TRANSITIONING);
				this.scroller.classList.add(CLASS_TRANSITIONING);
    ...
    var createPopup = function(html, callback) {
        ...
        popupStack.push({
            ...
            show: function(animate) {
                ...
                popupElement && popupElement.offsetHeight;
                popupElement && popupElement.classList.add(CLASS_POPUP_IN);
            },
            hide: function() {
				popupElement && (popupElement.style.display = 'none');
				popupElement && popupElement.classList.remove(CLASS_POPUP_IN);
            }
        });
        return popup;
    };
